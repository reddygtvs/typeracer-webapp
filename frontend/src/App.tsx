...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-5 pt-3 pb-3">
          <div className="flex justify-between items-center">
            ...
            {data && (
              <button
                onClick={handleReset}
                className="inline-flex items-center px-4 py-2 border border-border-default rounded-md text-sm font-medium text-text-secondary bg-transparent hover:bg-hover-bg hover:border-border-hover hover:text-text-accent transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-spotify focus:ring-offset-2 focus:ring-offset-black"
              >
      ...
      {/* Main Content */}
      <main className="pt-20 max-w-7xl mx-auto px-5 py-8">
        {!data ? (
