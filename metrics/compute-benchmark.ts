...
writeFileSync(new URL('./after-compute.json',import.meta.url),JSON.stringify({runtime:process.version,method:'Node.js on this Mac; parse + stats + all 20 chart calculations, excludes rendering and worker messaging.',runs},null,2));
